...
function addUser(fv){
         ...
         var url;
         if(action == "Add"){
             url = site_url+"stok_masuk/add";
         }else{
             url = site_url+"stok_masuk/update";
         }
         ...
         $.ajax({
                ...
                {
                    if(data.status){
                        location.replace(site_url + "stok_masuk");
                    }else{
                        alert('Fail');
                    }
                }
...
function change(id){
    ...
    $('#id').val(id);
    $.ajax({
            url : site_url+"stok_masuk/detail/"+id ,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
...
function getListBarang(result){
    $.ajax({
            url : site_url+"stok_masuk/getListBarang/"+editID,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
