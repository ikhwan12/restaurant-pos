<script>
    var id_order = "<?=$this->uri->segment(3);?>";
    var outlet = "<?=$this->session->userdata('outlet');?>";
</script>
<script src="<?php echo base_url('assets/js/app/assign_meja.js');?>"></script>
      ...
      <section class="content-header">
         <div class="row">
              <div  class="col-sm-4">
                  ...
                  <button id='addBtn' class="btn btn-flat btn-warning"><i class="fa fa-plus"></i> Tambah</button></div>
...
<section class="content" id="chair">
    ...
    ?>
                <div class="row">
                <div class="col-lg-2 col-xs-4" style="margin-top: 20px;">
                <a href="javascript:void(0);" onclick="chBo('<?=$item->id_order;?>','<?=$item->no_meja;?>')" >
                    <div class="info-box-icon bg-aqua trans" style="width: 100px; height: 100px"><i class="fa"><?=$item->no_meja;?></i>
                    </div>
                </a>
                </div>
    <?php
