...
<!-- Main content -->
                            ...
                            <div class="col-sm-6">    
                             ...
                             <div class="col-sm-12" id="rsp">  
                                  ...
                                  <table class="table table-striped table-condensed" width="100%" id="rspTab">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th colspan="2" ><a href="javascript:void(0);" id="addField2"><i class="fa fa-plus"></i> Tambah Produk</a></th>
                                        </tr>
                                    </tfoot>
                                  </table>  
  ...
  <div class="example-modal">
   ...
   <script src="<?php echo base_url('assets/js/app/stok_keluar.js');?>"></script>